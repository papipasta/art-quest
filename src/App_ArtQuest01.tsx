              ...
              <div className="flex flex-wrap gap-0.5 justify-center max-w-[90px]">
                {Object.values(completedArtworks).slice(0, 4).map((artwork) => (
                  <div key={artwork.playerId} className="relative group cursor-pointer p-1 hover:bg-amber-400/10 rounded transition-all" onClick={(e) => {
                    ...
                    {artwork.artStyle === '習作' ? (
                      <div 
                        className="w-6 h-6 rounded border bg-gradient-to-br from-gray-600 to-gray-700 flex items-center justify-center text-[8px] text-gray-300 shadow-sm hover:scale-105 transition-transform pointer-events-none"
                      ...
                      <img
                        ...
                        className="w-6 h-6 rounded border object-cover shadow-sm hover:scale-105 transition-transform pointer-events-none"
            ...
            {selectedArtwork.artStyle === '習作' ? (
              ...
              <div className="text-center">
                <img
                  ...
                  className="w-full max-w-[500px] mx-auto rounded-lg shadow-xl border border-amber-400/20"
                />
